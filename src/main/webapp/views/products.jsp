					...
					<td>
						<form action="products/update" method="get">
							...
							<button type="button" class="btn btn-warning" data-toggle="modal" data-target="#exampleModalCenter2"
									onclick="setProductValues(${product.id}, '${product.name}', '${product.category.name}', '${product.image}', ${product.quantity}, ${product.price}, ${product.weight}, '${product.description}')">Update
							</button>
									...
									<div class="modal-content">
										...
										<div class="modal-body text-center">
											<div class="form-group">
												<input class="form-control" type="number" readonly="readonly" name="productid" id="productid"
													   value="0">
											</div>
                                            <div class="form-group">
                                                <input class="form-control" type="text" readonly="readonly" name="categoryname" id="categoryname" value="categoryname">
                                            </div>
											<div class="form-group">
												<input class="form-control" type="text" name="productname" id="productname" value="productname">
											</div>
											<div class="form-group">
												<input class="form-control" type="text" name="productimage" id="productimage" value="productimage">
											</div>
											<div class="form-group">
												<input class="form-control" type="number" name="productquantity" id="productquantity" value="0">
											</div>
											<div class="form-group">
												<input class="form-control" type="number" name="productprice" id="productprice" value="0">
											</div>
											<div class="form-group">
												<input class="form-control" type="number" name="productweight" id="productweight" value="0">
											</div>
											<div class="form-group">
												<label for="productdescription"></label><textarea class="form-control" name="productdescription" id="productdescription"

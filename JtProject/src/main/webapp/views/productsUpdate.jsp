...
<div class="jumbotron container border border-info">
    ...
    <form action="updateData" method="get">
        <button type="button" class="btn btn-warning" data-toggle="modal"
                ...
                onclick="document.getElementById('productname').value =  '<%=DriverManager.getConnection("jdbc:mysql://localhost:3306/springproject", "root", "1598").createStatement().executeQuery("select * from products").getString(2)%>'; document.getElementById('id').value =  '<%=DriverManager.getConnection("jdbc:mysql://localhost:3306/springproject", "root", "1598").createStatement().executeQuery("select * from products").getString(1)%>'; ">
            Update
        </button>
        ...
        <div class="col-sm-5">
            ...
            <div class="custom-file">
                <input type="file" class="custom-file-input" name="productImage" value="${ pimage }"
